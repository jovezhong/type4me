...
**[下载 Type4Me v1.4.0](https://github.com/joewongjc/type4me/releases/tag/v1.4.0)** (macOS 14+)
...
下载 [Type4Me-v1.4.0.dmg](https://github.com/joewongjc/type4me/releases/download/v1.4.0/Type4Me-v1.4.0.dmg)，拖入 Applications 即可使用。仅支持云端识别引擎。
