...
**[下载 Type4Me v1.2.2](https://github.com/joewongjc/type4me/releases/tag/v1.2.2)** (macOS 14+)
...
下载 [Type4Me-v1.2.2.dmg](https://github.com/joewongjc/type4me/releases/download/v1.2.2/Type4Me-v1.2.2.dmg)，拖入 Applications 即可使用。仅支持云端识别引擎。
